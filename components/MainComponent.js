...
const CustomDrawerContentComponent = props => (
    <ScrollView>
        {/* it overwrite it, so it needs safeAreaView */}
        <SafeAreaView
...
const MainNavigator = createDrawerNavigator(
    {
        ...
        Contact : { 
            ...
            navigationOptions: {
                ...
                // tintColor is a build in method, it turns blue when it active,
                // grey when it's not. 
                drawerIcon: ({tintColor}) =>(
                    <Icon 
                        name='address-card'
    ...
    },
    {
        ...
        // it will connect with the main navigator, 
        // it also tells the main navigator to use that component to render the side drawer. 
    }
);
